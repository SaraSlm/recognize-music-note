...
image_dir_path = 'C:/Users/Salimian/Desktop/vision/notes_to_music/vision_project/dataset/validation/note_type'
image_dir_path_to = 'C:/Users/Salimian/Desktop/vision/notes_to_music/vision_project/dataset2/validation/note_type'
    ...
    for d in dirs[1]:
        for files in os.walk(image_dir_path+'/'+d):
            for filename in files[2]:
                ...
                horizontalsize = np.size(horizontal,1) / 10
                ...
                verticalsize = np.size(vertical,0) / 25
        ...
        # cv2.waitKey(0)
                ...
                # cv2.imshow('AND',AND)
                cv2.imwrite(image_dir_path_to+'/'+d+'/'+filename,AND)
    break
